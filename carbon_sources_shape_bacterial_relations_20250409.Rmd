---
title: "Carbon_sources_shape_bacterial_relations_20250409"
author: "HirokiOno"
date: "2025-04-09"
...
g <- ggplot(meanDF2, aes(x = ave12, y = mean, color = as.factor(pp))) +
  ...
  geom_point(size = 1.5) +
  scale_x_continuous(trans = "log10", limits = c(1e5, 1e10), expand = c(0, 0)) +
  scale_y_continuous(trans = "log10", limits = c(1e5, 1e10), expand = c(0, 0)) +
  theme_minimal() +
  theme(legend.position = "none",
        title = element_blank(),
        axis.line = element_line(size = 0.8, lineend = "square", color = "grey20"),
...
g <- ggplot(meanDF, aes(x = ave12, y = mean, color = pp)) +
  ...
  geom_point(size = 1.5) +
  scale_x_log10(limits = c(1e5, 1e10), expand = c(0, 0)) +
  scale_y_log10(limits = c(1e5, 1e10), expand = c(0, 0)) +
  theme_minimal() +
  theme(legend.position = "none",
...
g <- ggplot(meanDF, aes(x = "1", y = mean / ave12)) +
  ...
  geom_dotplot(binaxis = "y", dotsize = 0.75, alpha = 0.5, fill = NA,
               binwidth = 0.15, stackdir = "center", color = "black") +
  scale_y_log10(limits = c(0.01, 1000), expand = c(0, 0)) +
  labs(y = "") +
  theme_minimal() +
  theme(legend.position = "none",
...
for (i in 1:length(meanDF$envbac)) {
  ...
  g <- g + geom_segment(aes(x = x1, y = y1, xend = x2, yend = y2), color = "black", alpha = 0.3, 
                        data = errorDFx, linewidth = 0.2, linetype = "solid")
  g <- g + geom_segment(aes(x = x1, y = y1, xend = x2, yend = y2), color = "black", alpha = 0.3, 
                        data = errorDFy, linewidth = 0.2, linetype = "solid")
}
g
...
g <- ggplot(meanDF, aes(x = "1", y = mean / ave12)) +
  geom_hline(yintercept = 1, linetype = "dotted", linewidth = 1.2) +
  geom_boxplot(outlier.shape = NA, width = 0.4, color = "grey5") +
  geom_dotplot(binaxis = "y", dotsize = 0.65, alpha = 0.5, fill = NA, binwidth = 0.15, 
               stackdir = "center", color = "black") +
  scale_y_continuous(trans = "log10", limits = c(0.01, 1000), expand = c(0, 0)) +
  labs(y = "") +
  theme_minimal() +
...
g <- ggplot(meanDF, aes(x = ave12, y = mean, color = as.factor(pp))) +
  ...
  scale_y_continuous(trans = "log10", limits = c(100000, 10000000000), expand = c(0, 0)) +
  theme_minimal() +
  theme(legend.position = "none", title = element_blank(), axis.line = element_line(size = 0.8, lineend = "square", color = "grey20"),
        axis.ticks = element_line(size = 0.8, lineend = "square", color = "grey20"), axis.title = element_blank(),
        axis.text = element_blank(), plot.margin = margin(t = 160, r = 160, b = 0, l = 0, unit = "pt")) +
  scale_color_manual(values = c(rgb(red = 184, green = 153, blue = 58, maxColorValue = 255),
                               "grey70", rgb(red = 58, green = 184, blue = 153, maxColorValue = 255))) +
  coord_fixed(ratio = 1, xlim = NULL, ylim = NULL, expand = TRUE)
...
for (i in 1:length(meanDF$envbac)) {
  temp <- meanDF[i, ]
  errorDFx <- data.frame(x1 = (temp$ave12 - temp$sdx), y1 = temp$mean, x2 = (temp$ave12 + temp$sdx), y2 = temp$mean)
  errorDFy <- data.frame(x1 = temp$ave12, y1 = (temp$mean - temp$sdy), x2 = temp$ave12, y2 = (temp$mean + temp$sdy))
...
g <- ggplot(meanDF, aes(x = "1", y = mean / ave12)) +
  geom_hline(yintercept = 1, linetype = "dotted", linewidth = 1.2) +
  geom_boxplot(outlier.shape = NA, width = 0.4, color = "grey5") +
  geom_dotplot(binaxis = "y", dotsize = 0.65, alpha = 0.5, fill = NA, binwidth = 0.15, stackdir = "center", color = "black") +
  scale_y_continuous(trans = "log10", limits = c(0.01, 1000), expand = c(0, 0)) +
  labs(y = "") +
  theme_minimal() +
  theme(legend.position = "none", plot.margin = margin(t = 0, r = 0, b = 0, l = 0, unit = "pt"))
...
for (i in 1:length(medDF$envbac)) {
  ...
  g <- g + geom_segment(aes(x = x1, y = y1, xend = x2, yend = y2), color = "black", alpha = 0.3, data = errorDFx, linewidth = 0.2)
  g <- g + geom_segment(aes(x = x1, y = y1, xend = x2, yend = y2), color = "black", alpha = 0.3, data = errorDFy, linewidth = 0.2)
}
g
...
g <- ggplot(medDF, aes(x = "1", y = med / ave12)) +
  ...
  labs(y = "") +
  theme_minimal() +
  theme(legend.position = "none", plot.margin = margin(0, 0, 0, 0, unit = "pt"))
g
...
for (i in 1:length(medDF$envbac)) {
  temp <- medDF[i, ]
  errorDFx <- data.frame(
    x1 = temp$ave12 - temp$sdx,
    y1 = temp$med,
    x2 = temp$ave12 + temp$sdx,
    y2 = temp$med
  )
  errorDFy <- data.frame(
    x1 = temp$ave12,
    y1 = temp$med - temp$sdy,
    x2 = temp$ave12,
    y2 = temp$med + temp$sdy
  )
  g <- g + geom_segment(aes(x = x1, y = y1, xend = x2, yend = y2),
                        color = "black", alpha = 0.3, data = errorDFx, linewidth = 0.2)
  g <- g + geom_segment(aes(x = x1, y = y1, xend = x2, yend = y2),
                        color = "black", alpha = 0.3, data = errorDFy, linewidth = 0.2)
}
g
...
g <- ggplot(medDF, aes(x = "1", y = med / ave12)) +
  ...
  geom_boxplot(outlier.shape = NA, width = 0.4, color = "grey5") +
  geom_dotplot(
    binaxis = "y", dotsize = 0.65, alpha = 0.5,
    fill = NA, binwidth = 0.15, stackdir = "center", color = "black"
  ) +
  scale_y_continuous(trans = "log10", limits = c(0.01, 1000), expand = c(0, 0)) +
  labs(y = "") +
  theme_minimal() +
